...
public class FileHandler {
    private static final String FILE_NAME = "JavaDBStore.txt";
    ...
    public void clearUserData() {
        try (PrintWriter writer = new PrintWriter(new FileWriter(FILE_NAME))) {
            writer.print("");
            System.out.println("File data cleared successfully!");
        } catch (IOException e) {
            System.out.println("Error clearing data in file: " + e.getMessage());
        }
    }

    public void uploadFileDataToDB(DBFOperations dbconn) {
