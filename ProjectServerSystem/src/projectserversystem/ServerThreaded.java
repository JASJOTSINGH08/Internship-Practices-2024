...
public class ServerThreaded extends Thread {
    ...
    private final ProjectServerSystem server;
    private final HashMap<String, ServerThreaded> clientMap;
    private String clientName;
    private PrintWriter output;
    private BufferedReader input;

    public ServerThreaded(Socket socket, ProjectServerSystem server, ArrayList<ServerThreaded> threadList, HashMap<String, ServerThreaded> clientMap) {
        this.socket = socket;
        this.server = server;
